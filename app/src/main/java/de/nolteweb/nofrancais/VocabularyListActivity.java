...
/**
 * An activity representing a list of Vocabularies. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link VocabularyDetailActivity} representing
...
public class VocabularyListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.vocabulary_detail_container) != null) {
    ...
    public static class SimpleItemRecyclerViewAdapter
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    mParentActivity.getSupportFragmentManager().beginTransaction()
                            .replace(R.id.vocabulary_detail_container, fragment)
                            .commit();
                } else {
                    Context context = view.getContext();
                    Intent intent = new Intent(context, VocabularyDetailActivity.class);
                    intent.putExtra(VocabularyDetailFragment.ARG_ITEM_ID, item.id);
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.vocabulary_list_content, parent, false);
